...
unsigned int Utils::getPixel(TextureResource *Resource, int x, int y) 
{
    if(!Resource) {
...
void Utils::setPixel(TextureResource *Resource, int x, int y, unsigned int newColor)
{
    if(!Resource) {
        fprintf(stderr, "Resource is NULL\n");
        return;
...
TextureResource * Utils::MirrorTextureX( TextureResource * Resource )
{
    if(!Resource) {
        fprintf(stderr, "Resource is NULL\n");
        return NULL;
    ...
    TextureResource *texRes = new TextureResource(Resource->resourceid + "_reverse", 
    ...
    Globals::resourceManager.attachTexture(texRes);
    return texRes;
#endif  
}

TextureResource * Utils::MirrorTextureY( TextureResource * Resource )
{ 
    if(!Resource) {
        fprintf(stderr, "Resource is NULL\n");
        return NULL;
...
TextureResource * Utils::RotateTexture( TextureResource * Resource, float Angle)
{
    if(!Resource) {
        fprintf(stderr, "Resource is NULL\n");
        return NULL;
